...
cursor.execute('Create Table IF NOT EXISTS temp(Room_No int NOT NULL  ,DateofEntry Date,Name varchar(25),PhoneNO bigint ,AddharNo int(10),Room_Type varchar(15),DateofEXIT Date,RoomExpenditure int(6),OtherExpenditure int(5),Primary key(Room_No))')
...
def temp():
    ...
    for i in rec :
        print('|',i[0],' '*(6-(len(str(i[0])))),'|',i[1],' '*(1-(len(str(i[1])))),'|',i[2],
              ...
              '|',i[5],' '*(11-(len(str(i[5])))),'|',i[6],' '*(10-(len(str(i[6])))),'|',i[7],' '*(10-(len(str(i[7])))),'|',i[8],' '*(7-(len(str(i[8])))),'|')
    print('+--------------------------------------------------------------------------------------------------------------------------+')
    ...
    while o=='y':
        ...
        if u==1:
            ...
            if p==1:
                ...
                phno=int(input("Enter Addharcard Number:"))
                val.append(phno)
                val.append(rno)
